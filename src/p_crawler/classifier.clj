(ns p-crawler.classifier
  ...
  (:import [java.net URL]
           [de.l3s.boilerpipe.extractors ArticleExtractor DefaultExtractor KeepEverythingExtractor]
...
(defn tokenize [content]
  (vec (map (comp remove-unnecessary-punctuation lower-case)
            (UnicodeTokenizer/tokenize content))))
